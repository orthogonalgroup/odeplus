...
Every issue we take on appears on a public board with one of five states:

| State | Meaning |
| --- | --- |
| **New** | Filed, not yet triaged |
| **Acknowledged** | Confirmed as a valid report; being evaluated for scheduling |
| **In Progress** | Being worked on |
| **Shipped** | Released |
| **Won't Do** | We decided not to do it — **always with a stated reason**. We do not close things silently |
